...
export const GALLERY_CARDS: GalleryCard[] = [
  ...
  { id: "2", projectIds: ["22-almaty-museum"], name: "ALMATY MUSEUM OF ARTS", blockNumber: 2 },
  { id: "3", projectIds: ["11-rams-signature"], name: "RAMS SIGNATURE", blockNumber: 3 },
  { id: "4", projectIds: ["12-rams-saiahat"], name: "RAMS SAIAHAT", blockNumber: 4 },
  { id: "5", projectIds: ["15-rams-evo"], name: "RAMS EVO", blockNumber: 5 },
  { id: "6", projectIds: ["08-vostochny-park"], name: "VOSTOCHNY PARK", blockNumber: 6 },
  { id: "7", projectIds: ["05-dom-na-abaya"], name: "DOM NA ABAYA", blockNumber: 7 },
  { id: "8", projectIds: ["26-marriott-issykkul"], name: "MARRIOTT ISSYK-KUL", blockNumber: 8 },
  { id: "9", projectIds: ["23-haval", "27-hyundai", "24-lukoil"], name: "HAVAL • HYUNDAI • LUKOIL", blockNumber: 9 },
  { id: "10", projectIds: ["18-lamiya"], name: "LAMIYA", blockNumber: 10 },
  { id: "11", projectIds: ["20-ile-de-france"], name: "ILE DE FRANCE", blockNumber: 11 },
  { id: "12", projectIds: ["13-rams-garden-atyrau"], name: "RAMS GARDEN", title: "ATYRAU", blockNumber: 12 },
  { id: "13", projectIds: ["21-forum-residence"], name: "FORUM RESIDENCE", blockNumber: 13 },
  { id: "14", projectIds: ["19-la-verde"], name: "LA VERDE", blockNumber: 14 },
  { id: "15", projectIds: ["17-ortau", "14-ortau-marriott-bc"], name: "ORTAU", blockNumber: 15 },
];
